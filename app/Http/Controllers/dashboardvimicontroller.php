...
class dashboardvimicontroller extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        VisiMisi::where('id', $id)->update($validate);

        return redirect('/dashboard/VisiMisi')->with('success', 'Post has been updated');
    }
