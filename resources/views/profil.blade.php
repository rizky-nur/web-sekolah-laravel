    ...
    <div class="container mt-5">
      <div class="col shadow">
        ...
        <div class="d-flex">
          ...
          <h2 class="ps-5">{{$sejarah->title}}</h2>
        </div>
        <div class="mx-3 mb-3">{!!$sejarah->body!!}</div>
        @endforeach
      </div>
    </div>
    ...
    <div class="container">
      <div class="col mt-3 shadow">
        ...
        <div class="d-flex ps-3">
          <div class="border border-2 border-primary"></div>
          <h2 class="ps-5">{{$visimisi->title}}</h2>
        </div>
        <div class="ms-3 mb-5">{!!$visimisi->body!!}</div>
        @endforeach
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col mt-3 shadow">
          ...
          <div class="d-flex ps-3">
            <div class="border border-2 border-primary"></div>
            <h2 class="ps-5">{{$struktur->title}}</h2>
          </div>
          <div class="ms-5 mb-3">{!!$struktur->body!!}</div>
          @endforeach
        </div>
