  ...
  <body>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col">
          <div class="d-flex">
            <h4 class="ps-2">Direktorasi Peserta Didik</h4>
          ...
          <table class="table table-striped w-100 text-center mt-3">
          ...
          <div class="col-12 shadow mt-3">
            <div class="d-flex">
              <div class="border border-2 border-primary my-3 ms-2"></div>
              <h4 class="ps-2 my-3">OSIS</h4>
              <a href="/osis" class="btn btn-info ms-auto me-3 my-3 text-center">Detail</a>
            </div>
          </div>
          <div class="col-12 shadow mt-3">
            <div class="d-flex">
              <div class="border border-2 border-primary my-3 ms-2"></div>
              <h4 class="ps-2 my-3">MPK</h4>
              <a href="/mpk" class="btn btn-info ms-auto me-3 my-3 text-center">Detail</a>
            </div>
          </div>
          <div class="col-12 shadow mt-3">
            <div class="d-flex">
              <div class="border border-2 border-primary my-3 ms-2"></div>
              <h4 class="ps-2 my-3">PKS</h4>
              <a href="/pks" class="btn btn-info ms-auto me-3 my-3 text-center">Detail</a>
            </div>
          </div>
        </div>
