  ...
  <body>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col">
          <div class="d-flex">
            <h4 class="ps-2">Guru dan Tenaga Kependidikan</h4>
          </div>
          ...
          <div class="col-12 shadow mt-3">
            <div class="d-flex">
              ...
              <h4 class="ps-2 my-3">Guru Berprestasi</h4>
             <a href="/guruberprestasi" class="btn btn-info ms-auto me-3 my-3 text-center">Detail</a>
            </div>
          </div>
        </div>
