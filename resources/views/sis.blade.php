      ...
      <div class="row">
        <div class="col">
          <div class="d-flex">
            ...
            <h2 class="ps-3">SIS</h2>
          </div>
          <div class="row">
            <div class="col d-flex">
              <img src="img/e-learning.png" width="250" height="200" alt="" class="my-5" />
            </div>
            <div class="col">
              <h3 class="ps-3 pt-5">E-LEARNING SMK N 1 BANTUL</h3>
              <a href="https://skansaba.id/login/index.php" class="btn btn-primary ms-3">Masuk</a>
            </div>
          </div>
        </div>
        <div class="col">
